...
public:
   ...
   */
  explicit DictionaryKeyWord(std::vector<std::string> &lines);
   ...
   * \note This function is `[[nodiscard]]` and `noexcept`.
   */
  [[nodiscard]] const std::string &type_ascii() const noexcept {
    return type_ascii_;
  }
   ...
   * \note This function is `[[nodiscard]]` and `noexcept`.
   */
  [[nodiscard]] const std::string &comment_short() const noexcept {
    return comment_short_;
  }
  ...
  compulsory_alternatives() const noexcept {
    return compulsory_alternatives_;
  }
   ...
   */
  [[nodiscard]] const std::vector<std::string> &
  required_keywords() const noexcept {
    return required_keywords_;
  }
   ...
   */
  [[nodiscard]] const std::vector<std::string> &
  conflicting_keywords() const noexcept {
    return conflicting_keywords_;
  }
