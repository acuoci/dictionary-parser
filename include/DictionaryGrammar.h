...
public:
   ...
   */
  void ReadFromFile(std::string_view file_name);
...
protected:
   ...
   */
  [[nodiscard]] bool
  CheckForHelpKeyWord(std::vector<std::string> &list_of_keywords);
   ...
   */
  [[nodiscard]] bool
  CheckUndefinedKeyWords(std::vector<std::string> &list_of_keywords);
   ...
   */
  [[nodiscard]] bool
  CheckCompulsoryKeyWords(std::vector<std::string> &list_of_keywords);
   ...
   */
  [[nodiscard]] bool
  CheckRequiredKeyWords(std::vector<std::string> &list_of_keywords);
   ...
   */
  [[nodiscard]] bool
  CheckConflictingKeyWords(std::vector<std::string> &list_of_keywords);
   ...
   * \note This function is `[[nodiscard]]`.
   */
  [[nodiscard]] bool CheckType(std::string_view keyword_name,
